  ...
  return (
    <div className="p-[1.2cm] text-slate-900 leading-[1.4] bg-white min-h-full font-serif" style={{ fontFamily: "'Lora', serif" }}>
      ...
      <header className="text-center mb-8">
        <h1 className="text-[26px] font-bold mb-2 uppercase tracking-wide text-slate-900">{data.name}</h1>
        <div className="flex justify-center flex-wrap gap-x-3 gap-y-1 text-[11px] font-medium text-slate-700">
          <span>{data.phone}</span>
          <span className="text-slate-300">|</span>
          <a href={`mailto:${data.email}`} className="text-slate-900 underline underline-offset-2 decoration-slate-200 hover:decoration-slate-900 transition-all">{data.email}</a>
          <span className="text-slate-300">|</span>
