...
export default function ResumeBuilder() {
  ...
  return (
    <div className="h-screen flex bg-[#f8fafc] text-slate-900 overflow-hidden font-sans">
      ...
      <div className="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-6 gap-8 z-20 shrink-0">
        <Link to="/dashboard" className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all border border-slate-200 shadow-sm" title="Back to Dashboard">
        ...
        <div className="flex-1 flex flex-col items-center gap-4">
           <button 
             onClick={resetLayout}
             className="w-12 h-12 rounded-2xl bg-white border border-slate-200 text-slate-400 hover:text-[#0ea5e9] hover:bg-[#f0f9ff] hover:border-[#bae6fd] flex items-center justify-center transition-all shadow-sm"
      ...
      {/* 2. Editor Pane */}
      <div className="w-[450px] xl:w-[500px] bg-white border-r border-slate-200 flex flex-col h-screen overflow-y-auto shrink-0 z-10 shadow-sm">
        <div className="p-8 border-b border-slate-100 sticky top-0 bg-white/95 backdrop-blur-sm z-10">
           <h1 className="text-2xl font-bold tracking-tight text-slate-900">Content Editor</h1>
           <p className="text-sm text-slate-500 font-medium mt-1">Refine your professional details here.</p>
        </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="col-span-2">
                ...
                <input name="name" value={formData.name} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              <div className="col-span-2">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block">Professional Title</label>
                <input name="title" value={formData.title} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              <div>
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block">Email</label>
                <input name="email" value={formData.email} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              <div>
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block">Phone</label>
                <input name="phone" value={formData.phone} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              <div>
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block">Location</label>
                <input name="location" value={formData.location} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              <div>
                <div className="flex justify-between items-center mb-2">
                   <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block">LinkedIn</label>
                   {!showGitHub && (
                     <button onClick={() => setShowGitHub(true)} className="text-[10px] font-bold text-[#0ea5e9] hover:underline">+ Add GitHub</button>
                   )}
                </div>
                <input name="linkedin" value={formData.linkedin} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
              </div>
              {showGitHub && (
                <div className="col-span-2">
                  <div className="flex justify-between items-center mb-2">
                     <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block">GitHub</label>
                     <button onClick={() => setShowGitHub(false)} className="text-[10px] font-bold text-red-400 hover:underline">Remove</button>
                  </div>
                  <input name="github" value={formData.github} onChange={handleChange} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-[#0ea5e9]/5 transition-all" />
                </div>
              )}
          ...
          {[
            ...
            <section key={s.id}>
              ...
              <textarea 
                ...
                className={`w-full ${s.height} bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-sm font-medium outline-none focus:border-[#0ea5e9] focus:ring-4 focus:ring-[#0ea5e9]/5 transition-all resize-none leading-relaxed`} 
              />
            </section>
          ))}
        </div>
      ...
      {/* 3. Preview Pane */}
      <div className="flex-1 h-screen overflow-y-auto bg-[#fafafa] flex flex-col items-center p-12">
        {/* Toolbar */}
        <div className="w-full max-w-[850px] flex justify-between items-center mb-10 shrink-0">
           <div className="flex items-center gap-3">
              <button 
                onClick={resetLayout}
                className="group flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 transition-all shadow-sm"
              >
           ...
           <div className="flex items-center gap-3">
              <button 
                ...
                className="bg-white border text-xs font-bold border-slate-200 px-5 py-2.5 rounded-xl transition-all shadow-sm flex items-center gap-2 hover:bg-slate-50 text-slate-600"
              >
              ...
              <button 
                ...
                className="bg-[#111] text-white text-xs font-bold px-6 py-2.5 rounded-xl shadow-xl hover:bg-black transition-all flex items-center gap-2"
              >
        ...
        <div className="w-full flex-1 flex justify-center">
          <div 
             ref={resumeRef} 
             className="w-full max-w-[794px] bg-white min-h-[1123px] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-200 origin-top mb-24 transition-all duration-500 overflow-hidden"
          >
